...
$("style").last().append(`
#users .uzr.dagh2 .fitimg.u-pic {width: 58px !important;
...
#users .uzr.dagh2 .d-flex.dots {
  margin-top: 7px !important;
  margin-left: 5px;
}
#users .uzr.dagh2 .u-msg {
    text-align: center;
...
#users .uzr.dagh2 span.uhash {
  margin-right: 324px;
  margin-top: 24px;
  margin-left: 0px;
}
#users .uzr.dagh2 img.co {
...
#users .uzr.dagh2 .c-flex.fr {
  height: 0px !important;
  margin-left: -4px!important;
}    
#upro.dagh2 .light.fl.pro.break {
    background-image: url(https://up6.cc/2023/12/170215305562121.jpg);
    background-size: 100%;
}
#users .uzr.dagh2 .d-flex.fl {
  padding-right: 0px !important;
}
#users .uzr.dagh2 .u-topic {
