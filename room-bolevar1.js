var rid='18f0369e237xb5fa9ab7xqr4c8e';
$("style:eq(0)").append(`#d2 .roomh[onclick="rjoin('${rid}')"]{
background-size: 220% auto;border-radius:  50px!important;border: 1px solid #0000;
}`);

$(`<style>
.nosel.d-flex.room.r18f0369e237xb5fa9ab7xqr4c8e .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r18f0369e237xb5fa9ab7xqr4c8e .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
letter-spacing: 1px;
...
.nosel.d-flex.room.r18f0369e237xb5fa9ab7xqr4c8e .corner.fa.fa-user.label.label-primary.uc {
  letter-spacing: 1px;
  -webkit-text-fill-color: #fff;
  border-radius: 15px 0px 15px 0px !important;
  height: 27px;
...
.nosel.d-flex.room.r18f0369e237xb5fa9ab7xqr4c8e .dots.mini.u-msg {
text-align: center;
...
.nosel.d-flex.room.r18f0369e237xb5fa9ab7xqr4c8e {
...
.nosel.d-flex.room.r18f0369e237xb5fa9ab7xqr4c8e .u-topic.dots {
